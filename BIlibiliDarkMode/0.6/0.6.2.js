...
(function () {
    ...
    function main() {
        ...
        //newly style
        var n_root = `:root{--bg:#161819;--navBg:#141414;--color1:#e1e1e1;--color2:hsla(0,0%,88.2%,0.88);--color2dark:hsla(0,0%,88.2%,0.91);--color3:#e7e7e7;--color4:hsla(0,0%,88.2%,0.82);--subColor1:#bcbcbc;--fill1:#3b3b3b;--fill2:#2b2b2b;--fill3:#505050;--fill4:#5b5b5b;--fill5:#424242;--fill6:#2a2a2a;--fill7:#676767;--opacity1:rgba(34,34,34,0.13);--btn-on-fill1:#4f4f4f;--btn-on-fill2:#404040;--btn-on-fill3:#4a4a4a;--card:#222;--border:hsla(0,0%,73.7%,0.18);--borderLight:hsla(0,0%,73.7%,0.5)}`;
        var n_mainNav = `.bili-header .center-search-container .center-search__bar #nav-searchform{background:#505050}.bili-header .center-search-container .center-search__bar .nav-search-btn,.bili-header .center-search-container .center-search__bar .nav-search-input{color:hsla(0,0%,88.2%,.88)}.bili-header .center-search-container .center-search__bar .nav-search-btn{width:45px;height:39.26px;border-radius:0 8px 8px 0;background:var(--fill4);top:0!important;right:0!important}input::-webkit-input-placeholder{color:var(--color2)!important}.bili-header .center-search-container .center-search__bar #nav-searchform.is-focus{background:0 0}.bili-header .center-search-container .center-search__bar #nav-searchform:hover{background-color:var(--fill5)}.bili-header .search-panel{background:var(--card);border:1px solid var(--card)}.bili-header .header .title{color:var(--color2)}.bili-header .center-search-container .center-search__bar #nav-searchform.is-focus{border:1px solid var(--fill1);background:var(--fill1)}.bili-header .center-search-container .center-search__bar .nav-search-input:active{background-color:var(--btn-on-fill1);color:var(--color2)}.bili-header .trending-item{margin:0 10px;border-radius:8px}.bili-header .trending-item .rank.top{color:var(--color3)}.bili-header .histories .history-item .history-text,.bili-header .trending-item .rank,.bili-header .trending-item .trending-text{color:var(--color2)}.bili-header .histories .history-item{background:var(--fill2)}.bili-header .trending-item.active,.bili-header .trending-item:focus,.bili-header .trending-item:hover{background:var(--fill6)}.bili-header .center-search-container .center-search__bar .nav-search-input:focus{background-color:var(--btn-on-fill1);color:var(--color2)}.bili-header.fixed-top .bili-header__bar #nav-searchform:hover{border:1px solid var(--fill5);background:var(--fill5)}.bili-header .header-entry-avatar{border:2px solid var(--opacity1)}.bili-header .avatar-panel-popover{background-color:var(--card)}.bili-header .avatar-panel-popover .links-item .single-link-item .link-title{color:var(--color2)}.bili-header .avatar-panel-popover .links-item .single-link-item:hover{background-color:var(--fill6)}.bili-header .avatar-panel-popover .counts-item .single-count-item .count-num,.bili-header .avatar-panel-popover .logout-item{color:var(--color2)}.bili-header .avatar-panel-popover .coins-item .coin-item__num,.bili-header .avatar-panel-popover .coins-item .coin-item__text,.bili-header .avatar-panel-popover .counts-item .single-count-item .count-text{color:var(--subColor1)}.bili-header .avatar-panel-popover .split-line{background:var(--border)}.bili-header .avatar-panel-popover .level-item .level-item__bar .level-progress{background-color:var(--fill3)}.bili-header .avatar-panel-popover .level-item .level-item__bar--next{background:var(--fill7)}.bili-header .avatar-panel-popover .links-item .single-link-item .link-icon--right,.bili-header .level-intro-popover .level-intro .level-intro__title{color:var(--color2)}.bili-header .level-intro-popover .level-intro__content--title{color:var(--color4)}.bili-header .level-intro-popover .level-intro__content--info{color:var(--subColor1)}.bili-header .vip-panel-popover .vip-title{color:var(--color1)}.bili-header .vip-panel-popover .vip-content__item .recommend-link{color:var(--color2)}.bili-header .message-entry-popover .message-inner-list__item{padding:10px 0 9px 27px;color:var(--color2);border-radius:4px}.bili-header .message-entry-popover .message-inner-list{padding:12px 0;margin:0 4px}.bili-header .upload-panel-popover .upload-item .item-title{color:var(--color2)}.history-panel-popover .header-tabs-panel__item{border-bottom:3px solid var(--fill2);color:var(--color2)}.history-panel-popover .header-history-card__info--title{color:var(--color2)}.bili-header .header-history-video:hover{background:var(--fill6)}.history-panel-popover .header-tabs-panel__item--active{border-bottom:3px solid #00aeec!important;color:#00aeec!important}.history-panel-popover .header-tabs-panel{border-bottom:1px solid hsla(0,0%,73.7%,.18)}.history-panel-popover .header-tabs-panel__item--active{background-color:var(--fill2)}.bili-header .header-fav-card__info--title,.favorite-panel-popover__nav .tab-item__title{color:var(--color2)}.bili-header .header-fav-card:hover{background:var(--fill6)}.favorite-panel-popover__content .content-bottom__btn--view{border-right:1px solid var(--border)}.favorite-panel-popover__content .content-bottom{border-top:1px solid var(--border)}.favorite-panel-popover__nav{border-right:1px solid var(--border)}.bili-header .live,.bili-header .live-left{background:var(--card)}.bili-header .live-right{background:var(--card);border-radius:8px}.bili-header .live .title,.bili-header .live-left-list-item-text{color:var(--color2);border-radius:8px}.bili-header .live-left-list{border-right:.5px solid var(--border)}.bili-header .game{background:var(--card)}.bili-header .game-right-list-item,.bili-header .game-right-title{color:var(--color2)}.bili-header .game-left{border-right:.5px solid var(--border)}.bili-header .game-left-panel-item-title{color:var(--color2)}.bili-header .manga{background:var(--card)}.bili-header .manga-left-item-title,.bili-header .manga-right-list-item-text,.bili-header .manga-right-title{color:var(--color2)}.bili-header .manga-left{border-right:.5px solid var(--border)}.download-entry-popover.download-entry-popover{border:1px solid #222;background-color:#222}.download-entry-popover.download-entry-popover .txt{color:var(--color2)}.download-entry-popover.download-entry-popover .img-box{border:1px solid var(--borderLight)}.download-entry-popover.download-entry-popover .img-box>img{opacity:.7}.bili-header.fixed-top .bili-header__bar{background:var(--navBg)}.bili-header .mini-header-left-entry .left-entry__title .mini-header__title>span,.bili-header.fixed-top .bili-header__bar .mini-header-left-entry .default-entry,.bili-header.fixed-top .bili-header__bar .mini-header-left-entry .download-entry,.bili-header.fixed-top .bili-header__bar .mini-header-left-entry .entry-title,.bili-header.fixed-top .bili-header__bar .mini-header-left-entry .loc-mc-box__text,.bili-header.fixed-top .bili-header__bar .right-entry__outside .right-entry-icon,.bili-header.fixed-top .bili-header__bar .right-entry__outside .right-entry-text{color:var(--color2dark)}.out-container.new-container{border:1px solid #222!important}.split-line:before{border-top:1px solid hsla(0,0%,73.7%,.18)!important}.out-container.new-container .tab-bar .tab-item{border-bottom:3px solid var(--fill2)!important;color:var(--color2)!important}.out-container.new-container .tab-bar .tab-item.active{background-color:var(--fill2)!important;color:#00a1d6!important;border-bottom:.78534vw solid #00a1d6!important}`;
        var n_footer = `.bili-footer{background:var(--navBg)}.bili-footer .link-box .link-item .bt,.bili-footer a,.bili-footer p{color:var(--color4)}.bili-footer .split-line{background-color:var(--border)}.bili-footer .other-link .text-con__line--link,.footer-qrcode-popover .qrcode-text,.footer-wechat-popover .qrcode-text{color:var(--subColor1)}.footer-qrcode-popover .qrcode-box,.footer-wechat-popover .qrcode-box{border:1px solid var(--borderLight);opacity:.7}`;
        var n_channelNav = `.bili-header .bili-header__channel{background:var(--bg)}.bili-header .channel-icons .icon-title{color:var(--color1)}.bili-header .bili-header__channel .channel-entry-more__link,.bili-header .bili-header__channel .channel-link{color:var(--color2);border:1px solid var(--fill1);background-color:var(--fill1)}.bili-header .bili-header__channel .channel-entry-more__link:hover,.bili-header .bili-header__channel .channel-link:hover{background-color:var(--btn-on-fill1);color:var(--color2)}.channel-entry-popover .name,.more-channel-popover .name{color:var(--color2)}.v-popover-content{background-color:var(--card);border:1px solid var(--card)}.bili-header .suggest-item.active,.bili-header .suggest-item:focus,.bili-header .suggest-item:hover{background:var(--fill6)}.bili-header .suggest-item{margin:0 10px;border-radius:8px;color:var(--color2)}`;
