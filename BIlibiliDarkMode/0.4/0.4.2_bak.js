    ...
    function main() {
        ...
        function kit_addE() {
            var addE_Timer = setInterval(() => {
                if (document.getElementById("kitCard") != null) {
                    ...
                    document.getElementById("5_tabs").addEventListener('click', kit_brightnessE); //添加按钮监听
                    document.getElementById("6_tabs").addEventListener('click', kit_remAdE); //添加按钮监听
        ...
        function click(id) {
            ...
            if (id == 0) {
                ...
                var check = localStorage.getItem("mode");
